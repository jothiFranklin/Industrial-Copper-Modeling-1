...
if selected == "PREDICT SELLING PRICE":
    ...
    with st.form("my_form"):
        ...
        with col3:
            st.write(
                f'<h5 style="color:rgb(0, 0, 0);">NOTE: Min & Max given for reference, you can enter any value</h5>',
                unsafe_allow_html=True)
    ...
    if submit_button and flag == 0:
        ...
        with open(r"C:\Users\User\Desktop\ICM\Industrial-Copper-Modeling\model.pkl", 'rb') as file:
            loaded_model = pickle.load(file)
        with open(r"C:\Users\User\Desktop\ICM\Industrial-Copper-Modeling\scaler.pkl", 'rb') as f:
            scaler_loaded = pickle.load(f)

        with open(r"C:\Users\User\Desktop\ICM\Industrial-Copper-Modeling\t.pkl", 'rb') as f:
            t_loaded = pickle.load(f)

        with open(r"C:\Users\User\Desktop\ICM\Industrial-Copper-Modeling\s.pkl", 'rb') as f:
...
if selected == "PREDICT STATUS":
    ...
    if csubmit_button and cflag == 0:
        ...
        with open(r"C:\Users\User\Desktop\ICM\Industrial-Copper-Modeling\cmodel.pkl", 'rb') as file:
            cloaded_model = pickle.load(file)

        with open(r"C:\Users\User\Desktop\ICM\Industrial-Copper-Modeling\cscaler.pkl", 'rb') as f:
            cscaler_loaded = pickle.load(f)

        with open(r"C:\Users\User\Desktop\ICM\Industrial-Copper-Modeling\ct.pkl", 'rb') as f:
